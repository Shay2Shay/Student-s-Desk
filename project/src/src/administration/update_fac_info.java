...
public class update_fac_info {
    ...
    q1 = "UPDATE fac_info set Addhar_number = ? where ID = ?";
    q2 = "UPDATE fac_info set Phone_Number = ? where ID = ?";
    q3 = "UPDATE fac_info set Address = ? where ID = ?";
    q4 = "UPDATE fac_info set Address = ? , Phone_Number = ? , Address = ? where ID = ?";
    String address;
        try {
        conn cc = new conn();
    ...
    view_fac_details v = new view_fac_details();
